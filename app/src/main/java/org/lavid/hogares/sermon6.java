...
public class sermon6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sermon6);
        ...
        view = findViewById(R.id.txtSermon6);
        view.getSettings().setTextZoom(60);
        view.getSettings().setJavaScriptEnabled(true);
        view.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        view.loadData(getString(R.string.sermon6_text), "text/html", "UTF-8");
