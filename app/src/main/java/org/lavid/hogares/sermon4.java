...
public class sermon4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sermon4);
        ...
        view = findViewById(R.id.txtSermon4);
        view.getSettings().setTextZoom(60);
        view.getSettings().setJavaScriptEnabled(true);
        view.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        view.loadData(getString(R.string.sermon4_text), "text/html", "UTF-8");
