...
public class sermon5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sermon5);
        ...
        view = findViewById(R.id.txtSermon5);
        view.getSettings().setTextZoom(60);
        view.getSettings().setJavaScriptEnabled(true);
        view.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        view.loadData(getString(R.string.sermon5_text), "text/html", "UTF-8");
