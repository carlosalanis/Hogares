...
public class sermon2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sermon2);
        ...
        view = findViewById(R.id.txtSermon2);
        view.getSettings().setTextZoom(60);
        view.getSettings().setJavaScriptEnabled(true);
        view.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        view.loadData(getString(R.string.sermon2_text), "text/html", "UTF-8");
